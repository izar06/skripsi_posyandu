      ...
      <div class="row">
        <div class="col-12">
          <div class="d-sm-flex justify-content-start my-3">
            <a href="/dashboard/article/create" class="btn-sm btn-primary shadow-sm">
            <i class="fas fa-plus fa-sm text-white-50"></i> Tambah Artikel</a>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <form action="/dashboard/article/{{ $item->id }}" method="POST" class="d-inline">
                        @csrf
                        @method('delete')
